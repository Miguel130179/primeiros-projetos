...
let numero =  ncaixa.textContent
  ncaixa.textContent = numero + number
}
function clean(){
  ncaixa.textContent = ""
}
...
function calculo(){
  let resultado = ncaixa.textContent 
  if(resultado){
    ncaixa.textContent = eval(resultado)
  }
}
function clearone(){

let novacaixa = ncaixa.textContent.slice(0, - 1)
ncaixa.textContent = novacaixa
